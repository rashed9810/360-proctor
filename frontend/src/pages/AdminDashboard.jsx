    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="card bg-yellow-50 border border-yellow-100">
          ...
          <p className="mt-2 text-3xl font-bold text-yellow-900">{Math.round(stats.averageTrustScore * 100)}%</p>
        </div>
      </div>
              ...
              {users.map((user) => (
                <tr key={user.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link to={`/admin/users/${user.id}`} className="text-primary-600 hover:text-primary-900 mr-4">
                      {t('view')}
                    </Link>
                    <Link to={`/admin/users/${user.id}/edit`} className="text-secondary-600 hover:text-secondary-900">
                      {t('edit')}
                    </Link>
                  </td>
                </tr>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {exams.map((exam) => (
                <tr key={exam.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link to={`/exams/${exam.id}`} className="text-primary-600 hover:text-primary-900 mr-4">
                      {t('view')}
                    </Link>
                    <Link to={`/exams/${exam.id}/edit`} className="text-secondary-600 hover:text-secondary-900">
                      {t('edit')}
                    </Link>
                  </td>
                </tr>
