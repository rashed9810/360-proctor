    ...
    <div className="mt-1 space-y-2">
      ...
      {showCriteria && password && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 mt-2">
          <div
            className={`text-xs flex items-center ${hasMinLength ? 'text-green-600' : 'text-gray-500'}`}
          >
            <svg
          ...
          <div
            className={`text-xs flex items-center ${hasUpperCase ? 'text-green-600' : 'text-gray-500'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className={`text-xs flex items-center ${hasNumber ? 'text-green-600' : 'text-gray-500'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className={`text-xs flex items-center ${hasSpecialChar ? 'text-green-600' : 'text-gray-500'}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
