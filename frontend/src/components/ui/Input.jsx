...
const inputVariants = cva('input focus-ring', {
  variants: {
    variant: {
      default: '',
...
const Input = forwardRef(
  (
    ...
    // Calculate padding classes based on conditions
    const paddingClasses = {
      'pl-10': Icon && iconPosition === 'left',
      'pr-16': Icon && iconPosition === 'right' && isPassword && showPasswordToggle,
      'pr-10':
        (Icon && iconPosition === 'right' && !(isPassword && showPasswordToggle)) ||
        (isPassword && showPasswordToggle && !(Icon && iconPosition === 'right')),
    };
